...
const buildExit = template('__esTrace.exit("NAME", "URL");');
const buildReturn = template('{const TYPE = ARGUMENT; EXIT; return TYPE;}');
...
function isEnter(bodyPath) {
    ...
    return compare(first, '__esTrace.enter(__a, __b, __c)');
}
